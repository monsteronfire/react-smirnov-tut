...
export default class CartItem extends React.Component {
  ...
  render() {
    return <article className="row large-4">
        ...
        <p className="small-4 large-4 column"><strong>Quantity: </strong>{this.state.qty}</p>
        <p className="small-4 large-4 column">
          <button onClick={this.increaseQty.bind(this)} className="button success">+</button>
          <button onClick={this.decreaseQty.bind(this)} className="button alert">-</button>
        </p>
        <p className="small-4 large-4 column">
          <strong>Price per item: </strong>${this.props.price}
        </p>
